...
const Mant = () => {
    ...
    const toggleTaskDetails = (serviceName) => {
        setExpandedSections(prev => ({
            ...prev,
            taskDetails: {
                ...prev.taskDetails,
                [serviceName]: !prev.taskDetails[serviceName]
            }
        }));
    };
                                        ...
                                        {service.runningDetails.length > 0 && (
                                            <div style={{ marginTop: "15px" }}>
                                                <div
                                                    ...
                                                    onClick={() => toggleTaskDetails(`${service.name}-running`)}
                                                >
                                                    <h4 style={{ fontWeight: "bold", margin: 0 }}>
                                                        Running Task Details
                                                    </h4>
                                                    <FontAwesomeIcon
                                                        icon={expandedSections.taskDetails[`${service.name}-running`] ? faChevronDown : faChevronRight}
                                                        style={{ marginLeft: '10px' }}
                                                    />
                                                </div>
                                                {expandedSections.taskDetails[`${service.name}-running`] && (
                                                    <div style={{
                                                        padding: "10px",
                                        ...
                                        {service.stoppedDetails.length > 0 && (
                                            <div style={{ marginTop: "15px" }}>
                                                <div
                                                    ...
                                                    onClick={() => toggleTaskDetails(`${service.name}-stopped`)}
                                                >
                                                    <h4 style={{ fontWeight: "bold", margin: 0 }}>
                                                        Stopped Task Details
                                                    </h4>
                                                    <FontAwesomeIcon
                                                        icon={expandedSections.taskDetails[`${service.name}-stopped`] ? faChevronDown : faChevronRight}
                                                        style={{ marginLeft: '10px' }}
                                                    />
                                                </div>
                                                {expandedSections.taskDetails[`${service.name}-stopped`] && (
                                                    <div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <ul style={{ listStyle: 'none', padding: 0 }}>
                            ...
                            <li style={{ margin: '15px 0' }}>
                                <strong>Search</strong> - Filter by service name
                            </li>
                        </ul>
                        <button
