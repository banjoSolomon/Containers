...
const Meedle = () => {
    ...
    const sortedEc2Instances = useMemo(() => {
        let sortableItems = [...ec2Instances];
        if (sortConfig.key) {
    ...
    const filteredEc2Instances = useMemo(() => {
        return sortedEc2Instances.filter(instance =>
            ...
            (instance.type && instance.type.toLowerCase().includes(searchTerm.toLowerCase()))
        );
                    ...
                    <div style={{
                        ...
                        {expandedSections.ec2 && (
                            <div style={{
                                ...
                                {filteredEc2Instances.map((instance, index) => (
                                    <div
                                        key={`ec2-${index}`}
                                        style={{
                                        ...
                                        {dockerImages[instance.id] && (
                                            <div style={{ marginTop: "15px" }}>
                                                <button
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                                        toggleDockerImages(instance.id);
                                                    }}
                                                    style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <ul style={{ listStyle: 'none', padding: 0 }}>
                            ...
                            <li style={{ margin: '15px 0' }}>
                                <strong>Search</strong> - Filter by service name, IP, or type (EC2/ECS)
                            </li>
                        </ul>
                        <button
